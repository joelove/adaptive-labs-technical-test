Feature: Display messages page
  ...
  Scenario: Messages are displayed when clicking the "Fetch more messages" button
    When I click the "Fetch more messages" button
  ...
  Scenario: Duplicate messages should increment the appropriate message counter
    When I click the "Fetch more messages" button twice
